...
module.exports.shouldNotCleanTmpTables = (context) => {
    ...
    /*
        ...
        // (utils.compareDBVersion(version, '2.00.030.00.1515544046', utils.SAME_SPS) >= 0) || not directly released
    ...
    if ((utils.compareDBVersion(version, '1.00.122.16.1520578817', utils.SAME_SPS) === utils.VERSION_A_COVERS_VERSION_B) ||
        (utils.compareDBVersion(version, '1.01.000.00.0000000000', utils.SAME_HANA_REL) === utils.VERSION_A_COVERS_VERSION_B) ||

        (utils.compareDBVersion(version, '2.00.012.04.1517989041', utils.SAME_SPS) === utils.VERSION_A_COVERS_VERSION_B) ||

        (utils.compareDBVersion(version, '2.00.024.00.1520347815', utils.SAME_SPS) === utils.VERSION_A_COVERS_VERSION_B) ||

        (utils.compareDBVersion(version, '2.00.030.00.1522209842', utils.SAME_SPS) === utils.VERSION_A_COVERS_VERSION_B) ||
        (utils.compareDBVersion(version, '2.01.000.00.0000000000', utils.SAME_HANA_REL) === utils.VERSION_A_COVERS_VERSION_B) ||
